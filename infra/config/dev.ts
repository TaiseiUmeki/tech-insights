...
export const devConfig: EnvironmentConfig = {
  ...
  frontend: {
    ...
    // VPN 内などで同一 ALB にフロント ECS を載せる場合:
    // type: 'ecs',
    // ecsContainerPort: 80,
    // ecsBackendPathPatterns: ['/api/*', '/health', '/docs', '/openapi.json'],
  ...
  // securityMonitoring: {
  //   enabled: true,
  //   slackWebhookUrlParameterName: '/myapp/dev/slack-webhook-url',
  //   logRetentionDays: 30,
  ...
  // 💡 Route 53（既存ホストゾーンに ALB / CloudFront 向けエイリアスを追加）
  // route53: {
  //   enabled: true,
  //   hostedZoneId: 'Z1234567890ABC',
  //   zoneName: 'example.com',
  //   albRecordNames: ['api'], // 複数: ['app', 'api']（同一 ALB）
  //   cloudFrontRecordName: 'app', // frontend.type が s3-cloudfront のときのみ有効
  // },

  // 💡 Client VPN設定
  // VPN経由でALBにアクセスする場合は有効化
  // 事前にACMにサーバー/クライアント証明書をインポートする必要があります
  // 証明書生成: https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/mutual.html
  // clientVpn: {
  //   enabled: true,
  //   serverCertificateArn: 'arn:aws:acm:ap-northeast-1:123456789012:certificate/server-cert-id',
  //   clientCertificateArn: 'arn:aws:acm:ap-northeast-1:123456789012:certificate/client-cert-id',
